  ...
  trackTime = () => {
    this.tracker = setInterval(() => {
      ...
      this.player.getCurrentTime((seconds) => {
          ...
          if (trigger && triggerTime.endAfter && Math.floor(seconds) === triggerTime.startAt + triggerTime.endAfter) {
            this.nextTrigger()
          }
          if (trigger && Math.floor(seconds) === triggerTime.startAt) {
            if (stopMain) {
          ...
          if (Math.floor(seconds) >= triggerTime.startAt && ((Math.floor(seconds) <= triggerTime.endAt) || (Math.floor(seconds) <= triggerTime.startAt + triggerTime.endAfter)) && triggerTime.fadeIn && !triggerPictureShowed ) {
          ...
          if ((Math.floor(seconds) >= triggerTime.endAt || (Math.floor(seconds) >= triggerTime.startAt + triggerTime.endAfter)) && triggerTime.fadeOut && triggerPictureShowed ) {
